...
<head>
    ...
    <link href="yaksok/modal/css/yaksokReserveModalCSS.css" rel="stylesheet" type="text/css" />
    ...
    function calendarMaker(target, date) {
        ...
        function calMoveEvtFn() {
            ...
            $("#addButton").click(function() {
            	...
            	var selectMonth=$(".selectMonth").html();
            	var selectDay=$(".select_day .dayVal").html();
            	alert(selectYear+"/"+selectMonth+"/"+selectDay)
